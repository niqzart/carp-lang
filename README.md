...
## Модель процессора
### Реализация
- Арифметико-логическое устройство реализовано в отдельном файле в упрощённом виде (см. [alu.py](./carp/executor/alu.py))
- Все пассивные элементы процессора имитируются классом DataPath, реализованном в [wiring.py](./carp/executor/wiring.py)
- Класс ControlUnit, имитирующий контроллер процессора вынесен в отдельный файл [control.py](./carp/executor/control.py)
